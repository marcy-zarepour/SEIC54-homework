...
#plan_trip(line1,start,line2,destnation)
#line_array_start = N[(N.find_index("34th")..N.find_index("Union Square"))]

def plan_trip(line1,start,line2,destnation)
    if line1.find_index("start") < line1.find_index("Union Square")
    line_array_start = line1[(line1.find_index("start")..line1.find_index("Union Square"))]
    else
        line_array_start = 
    end
    if line2.find_index("destnation") < line2.find_index("Union Square")
        line_array_start = line2[(line2.find_index("destnation")..line2.find_index("Union Square"))]
    end
    line_trip = (line_array_start + line_array_start).flatten
end
